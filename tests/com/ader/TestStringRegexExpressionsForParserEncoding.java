...
public class TestStringRegexExpressionsForParserEncoding extends TestCase {
	...
	protected void setUp() {
		p = Pattern.compile(SmilFile.EXTRACT_ENCODING_REGEX);
	...
	public void testRegexDetectsEncoding() {
		...
		assertTrue(quirkyWindows1252EncodingString.matches(SmilFile.XML_FIRST_LINE_REGEX));
	}
	...
	public void testCanExtractIso9959_1Encoding() {
		...
		String encoding = isomatches[1].replace(SmilFile.XML_TRAILER, "").toLowerCase();
